...
<<<<<<< HEAD
  ...
  const newUser: typeof User = {
    ...
    email: "testing@gmail.com",
    userImage:
      "https://raw.githubusercontent.com/Zaiqin/NoExpiry/main/client/src/assets/screenshot.png",
    password: "password",
    isNewUser: true,
    name: "testing",
    DOB: "2011-11-15",
  ...
  return (
    <div>
      <button style={{ border: "1px black solid" }} onClick={handleFetchUsers}>
        Fetch All Users
      </button>{" "}
      <br />
      <button
        style={{ border: "1px black solid" }}
        onClick={() => handleGetUser("6651f520191db42519621f9b")}
      >
        Get User by ID
      </button>{" "}
      <br />
      <button
        style={{ border: "1px black solid" }}
        onClick={() => handleGetUserByEmail("john@example.com")}
      >
        Get User By Email
      </button>{" "}
      <br />
      ...
      <button
        style={{ border: "1px black solid" }}
        onClick={() => handleDeleteUser("6651e0ba94ee984b3c2436e4")}
      >
        Delete User
      </button>
      <br />
      <button
        style={{ border: "1px black solid" }}
        onClick={() => handleGetUserFriends("6651e3a081f554ce4a802128")}
      >
        Get User Friends
      </button>
      <br />
      <button
        style={{ border: "1px black solid" }}
        onClick={() => handleCheckName("grape grape")}
      >
        Check For Name
      </button>
      <br />
      <button
        style={{ border: "1px black solid" }}
        onClick={() => handleGetUserByName("testing")}
      >
        Get User by Name
      </button>
      <br />
      <button
        style={{ border: "1px black solid" }}
        onClick={() => handleAddFriend("organizer1", "testing5")}
      >
        Add Friend
      </button>
      <br />
      <button
        style={{ border: "1px black solid" }}
        onClick={() => handleAcceptFriendRequest("1d", "1c")}
      >
      ...
      <button
        style={{ border: "1px black solid" }}
        onClick={() => handleGetUserEvents("testing")}
      >
        Get Events
      </button>
      <br />
      <button
        style={{ border: "1px black solid" }}
        onClick={() => handleGetFriendEvents("testing")}
      >
      ...
      <button
        style={{ border: "1px black solid" }}
        onClick={() => handleGetOpportunity("6651df8aeaa03fa12bdc01e0")}
      >
      ...
      <button
        style={{ border: "1px black solid" }}
        onClick={() => handleAddNewOpportunity(newOpportunity)}
      >
        Add New Opportunity
      </button>
      <br />
      <button
        style={{ border: "1px black solid" }}
        onClick={() => handleDeleteOpportunity("6651ee9991b2c0fb293c7d34")}
      >
        Delete Opportunity
      </button>
      <br />
